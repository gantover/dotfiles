...
lvim.keys.normal_mode["<C-x>"] = ":MagmaEvaluateVisual<cr>"
vim.keymap.set("i", "<Tab>", "<C-R>=UltiSnips#ExpandSnippet()<CR>")
...
lvim.builtin.which_key.mappings["m"] = {
  ...
  l = { "<cmd>MagmaEvaluateLine<cr>", "Eval Line" },
  v = { "<cmd>MagmaEvaluateVisual<cr>", "Eval Visual" },
